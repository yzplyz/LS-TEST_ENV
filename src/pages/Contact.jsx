            ...
            >
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 p-4 rounded-lg border bg-card/50 transition-colors hover:bg-card">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:locscoutai@gmail.com" 
                        className="text-primary hover:underline"
                      >
                        locscoutai@gmail.com
                      </a>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-lg border bg-card/50 transition-colors hover:bg-card">
                    ...
                    <div>
                      ...
                      <p className="text-primary">Atlanta, Georgia</p>
                      <p className="text-sm text-muted-foreground mt-1">
                        United States
                      </p>
                    </div>
